...
//    public $debug = true;
    ...
    protected function initialize() {
        ...
        $this->validates_presence_of('observacion', 'message: Debe escribir una <b>Observación de la Organización</b>');
        $this->validates_uniqueness_of('descripcion', 'message: Esta Organización <b>ya existe</b> en el sistema');
    }
